...
public class MithrilModRecipeProvider extends FabricRecipeProvider {

    public MithrilModRecipeProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
