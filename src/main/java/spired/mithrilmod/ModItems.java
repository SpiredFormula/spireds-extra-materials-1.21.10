...
public class ModItems {
    ...
    // Create creative tab
    public static ResourceKey<CreativeModeTab> MITHRIL_GROUP_KEY = ResourceKey.create(BuiltInRegistries.CREATIVE_MODE_TAB.key(), ResourceLocation.fromNamespaceAndPath(MithrilMod.MOD_ID, "mithril_group"));
    public static final  CreativeModeTab MITHRIL_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(MITHRIL_INGOT)).title(Component.translatable("mithrilGroup.mithril-mod")).build();
    ...
    private static Item registerItem(String name, Function<Item.Properties, Item> itemFactory, Item.Properties settings) {
        ...
        ResourceKey<Item> itemKey = ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MithrilMod.MOD_ID, name));
